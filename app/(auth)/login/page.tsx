    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: "#FAFAF5" }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-gray-400 mt-1">Adesiyan Village, Olojuoro Road, Ibadan</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="mt-6 p-4 rounded-lg" style={{ background: "#E8F5E9" }}>
            <p className="text-xs font-medium text-green-800 mb-1">Default credentials:</p>
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            New to ASEDA Farm?{" "}
            <Link href="/register" className="font-medium" style={{ color: "#1B5E20" }}>Create an account</Link>
          </p>
        </div>
      </div>
    </div>
